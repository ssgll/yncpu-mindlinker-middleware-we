...
const {toString: mt} = Object.prototype, {getPrototypeOf: we} = Object, {iterator: se, toStringTag: Ve} = Symbol,
    oe = (e => t => {
        const n = mt.call(t);
        return e[n] || (e[n] = n.slice(8, -1).toLowerCase())
    })(Object.create(null)), P = e => (e = e.toLowerCase(), t => oe(t) === e),
    ie = e => t => typeof t === e, {isArray: $} = Array, M = ie("undefined");
...
const bt = ie("string"), T = ie("function"), Ke = ie("number"), K = e => e !== null && typeof e == "object",
    wt = e => e === !0 || e === !1, ee = e => {
    ...
    }, gt = P("Date"), St = P("File"), Rt = P("Blob"), Ot = P("FileList"), Tt = e => K(e) && T(e.pipe), At = e => {
        let t;
        return e && (typeof FormData == "function" && e instanceof FormData || T(e.append) && ((t = oe(e)) === "formdata" || t === "object" && T(e.toString) && e.toString() === "[object FormData]"))
    }, Ct = P("URLSearchParams"), [xt, Nt, Pt, Ft] = ["ReadableStream", "Request", "Response", "Headers"].map(P),
    Ut = e => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");

function v(e, t, {allOwnKeys: n = !1} = {}) {
    if (e === null || typeof e > "u") return;
    let r, s;
    if (typeof e != "object" && (e = [e]), $(e)) for (r = 0, s = e.length; r < s; r++) t.call(null, e[r], r, e); else {
        if (W(e)) return;
...
function he() {
    const {caseless: e, skipUndefined: t} = Xe(this) && this || {}, n = {}, r = (s, i) => {
        const o = e && ve(n, i) || i;
        ee(n[o]) && ee(s) ? n[o] = he(n[o], s) : ee(s) ? n[o] = he({}, s) : $(s) ? n[o] = s.slice() : (!t || !M(s)) && (n[o] = s)
    };
    for (let s = 0, i = arguments.length; s < i; s++) arguments[s] && v(arguments[s], r);
    return n
}

const _t = (e, t, n, {allOwnKeys: r} = {}) => (v(t, (s, i) => {
    n && T(s) ? e[i] = Je(s, n) : e[i] = s
}, {allOwnKeys: r}), e), Lt = e => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), kt = (e, t, n, r) => {
    ...
    for (; t-- > 0;) n[t] = e[t];
    return n
}, qt = (e => t => e && t instanceof e)(typeof Uint8Array < "u" && we(Uint8Array)), Ht = (e, t) => {
    ...
    return r
}, Mt = P("HTMLFormElement"), $t = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function (n, r, s) {
...
const Xt = e => {
        ...
        return n(e, 0)
    }, Gt = P("AsyncFunction"), Qt = e => e && (K(e) || T(e)) && T(e.then) && T(e.catch),
    Qe = ((e, t) => e ? setImmediate : t ? ((n, r) => (j.addEventListener("message", ({source: s, data: i}) => {
        s === j && i === n && r.length && r.shift()()
    }, !1), s => {
        r.push(s), j.postMessage(n, "*")
    }))(`axios@${Math.random()}`, []) : n => setTimeout(n))(typeof setImmediate == "function", T(j.postMessage)),
    Zt = typeof queueMicrotask < "u" ? queueMicrotask.bind(j) : typeof process < "u" && process.nextTick || Qe,
    Yt = e => e != null && T(e[se]), a = {
        isArray: $,
        isArrayBuffer: We,
        isBuffer: W,
        isFormData: At,
...
function ae(e, t, n) {
    ...
    t = t || new FormData, n = a.toFlatObject(n, {metaTokens: !0, dots: !1, indexes: !1}, !1, function (m, p) {
    ...
    function l(u, m, p) {
        ...
        if (u && !p && typeof u == "object") {
            if (a.endsWith(m, "{}")) m = r ? m : m.slice(0, -2), u = JSON.stringify(u); else if (a.isArray(u) && tn(u) || (a.isFileList(u) || a.endsWith(m, "[]")) && (E = a.toArray(u))) return m = et(m), E.forEach(function (g, O) {
                !(a.isUndefined(g) || g === null) && t.append(o === !0 ? Pe([m], O, i) : o === null ? m : m + "[]", f(g))
            }), !1
        }
        return me(u) ? !0 : (t.append(Pe(p, m, i), f(u)), !1)
    }

    const h = [], b = Object.assign(nn, {defaultVisitor: l, convertValue: f, isVisitable: me});

    function S(u, m) {
        if (!a.isUndefined(u)) {
            if (h.indexOf(u) !== -1) throw Error("Circular reference detected in " + m.join("."));
            h.push(u), a.forEach(u, function (E, C) {
                (!(a.isUndefined(E) || E === null) && s.call(t, E, a.isString(C) ? C.trim() : C, m, b)) === !0 && S(E, m ? m.concat(C) : [C])
            }), h.pop()
        }
    }
...
const rt = {silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1},
    sn = typeof URLSearchParams < "u" ? URLSearchParams : Ee, on = typeof FormData < "u" ? FormData : null,
    an = typeof Blob < "u" ? Blob : null, cn = {
        isBrowser: !0,
        classes: {URLSearchParams: sn, FormData: on, Blob: an},
        protocols: ["http", "https", "file", "blob", "url", "data"]
    }, ge = typeof window < "u" && typeof document < "u", ye = typeof navigator == "object" && navigator || void 0,
    ln = ge && (!ye || ["ReactNative", "NativeScript", "NS"].indexOf(ye.product) < 0),
    un = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function",
    fn = ge && window.location.href || "http://localhost", dn = Object.freeze(Object.defineProperty({
        __proto__: null,
        hasBrowserEnv: ge,
        ...
        navigator: ye,
        origin: fn
    }, Symbol.toStringTag, {value: "Module"})), R = {...dn, ...cn};
    ...
    transformRequest: [function (t, n) {
        ...
        if (i) {
            ...
            if ((c = a.isFileList(t)) || r.indexOf("multipart/form-data") > -1) {
                ...
                return ae(c ? {"files[]": t} : t, d && new d, this.formSerializer)
            }
        }
...
const bn = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
    wn = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
...
const re = (e, t, n = 3) => {
    ...
    Cn = R.hasStandardBrowserEnv ? ((e, t) => n => (n = new URL(n, R.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(R.origin), R.navigator && /(msie|trident)/i.test(R.navigator.userAgent)) : () => !0,
    xn = R.hasStandardBrowserEnv ? {
        write(e, t, n, r, s, i, o) {
...
const ct = e => {
    ...
    if (t.headers = o = A.from(o), t.url = nt(at(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && o.set("Authorization", "Basic " + btoa((c.username || "") + ":" + (c.password ? unescape(encodeURIComponent(c.password)) : ""))), a.isFormData(n)) {
        if (R.hasStandardBrowserEnv || R.hasStandardBrowserWebWorkerEnv) o.setContentType(void 0); else if (a.isFunction(n.getHeaders)) {
    ...
    return new Promise(function (n, r) {
        ...
        function E() {
            if (!p) return;
            const g = A.from("getAllResponseHeaders" in p && p.getAllResponseHeaders()), N = {
        ...
        "onloadend" in p ? p.onloadend = E : p.onreadystatechange = function () {
            ...
            const N = O && O.message ? O.message : "Network Error", k = new y(N, y.ERR_NETWORK, e, p);
        ...
        }), a.isUndefined(s.withCredentials) || (p.withCredentials = !!s.withCredentials), c && c !== "json" && (p.responseType = s.responseType), f && ([b, u] = re(f, !0), p.addEventListener("progress", b)), d && p.upload && ([h, S] = re(d), p.upload.addEventListener("progress", h), p.upload.addEventListener("loadend", S)), (s.cancelToken || s.signal) && (l = g => {
    ...
    for await(const n of Bn(e)) yield* Ln(n, t)
}, Bn = async function* (e) {
...
}, je = 64 * 1024, {isFunction: Y} = a, Dn = (({Request: e, Response: t}) => ({Request: e, Response: t}))(a.global), {
    ReadableStream: qe,
    TextEncoder: He
} = a.global, Ie = (e, ...t) => {
    try {
    ...
    e = a.merge.call({skipUndefined: !0}, Dn, e);
    const {fetch: t, Request: n, Response: r} = e, s = t ? Y(t) : typeof fetch == "function", i = Y(n), o = Y(r);
    if (!s) return !1;
    const c = s && Y(qe),
        d = s && (typeof He == "function" ? (u => m => u.encode(m))(new He) : async u => new Uint8Array(await new n(u).arrayBuffer())),
        f = i && c && Ie(() => {
            let u = !1;
            const m = new n(R.origin, {
                body: new qe, method: "POST", get duplex() {
                    return u = !0, "half"
                }
            }).headers.has("Content-Type");
            return u && !m
        }), l = o && c && Ie(() => a.isReadableStream(new r("").body)), h = {stream: l && (u => u.body)};
    ...
    const b = async u => {
        ...
        if (a.isSpecCompliantForm(u)) return (await new n(R.origin, {
            method: "POST",
            body: u
    ...
    return async u => {
        ...
        let Q = _n([C, g && g.toAbortSignal()], O), J = null;
        const B = Q && Q.unsubscribe && (() => {
            Q.unsubscribe()
        });
        let Te;
        try {
            if (k && f && p !== "get" && p !== "head" && (Te = await S(le, E)) !== 0) {
                let L = new n(m, {method: "POST", body: E, duplex: "half"}), I;
                if (a.isFormData(E) && (I = L.headers.get("content-type")) && le.setContentType(I), L.body) {
                    const [ue, Z] = Le(Te, re(ke(k)));
                    E = De(L.body, je, ue, Z)
                }
            }
            ...
            if (l && (N || Ce && B)) {
                ...
                const I = a.toFiniteNumber(_.headers.get("content-length")), [ue, Z] = N && Le(I, re(ke(N), !0)) || [];
                _ = new r(De(_.body, je, ue, () => {
                    Z && Z(), B && B()
                }), L)
            }
            x = x || "text";
            let ht = await h[a.findKey(h, x) || "text"](_, u);
            return !Ce && B && B(), await new Promise((L, I) => {
                it(L, I, {
                    data: ht,
            ...
            throw B && B(), F && F.name === "TypeError" && /Load failed|fetch/i.test(F.message) ? Object.assign(new y("Network Error", y.ERR_NETWORK, u, J), {cause: F.cause || F}) : y.from(F, F && F.code, u, J)
        }
    }
}, qn = new Map, lt = e => {
    let t = e && e.env || {};
    ...
    for (; c--;) d = i[c], f = l.get(d), f === void 0 && l.set(d, f = c ? new Map : jn(t)), l = f;
    return f
};
lt();
const Se = {http: en, xhr: Un, fetch: {get: lt}};
a.forEach(Se, (e, t) => {
    if (e) {
        try {
...
function In(e, t) {
    ...
    for (let o = 0; o < n; o++) {
        r = e[o];
        let c;
        if (s = r, !Hn(r) && (s = Se[(c = String(r)).toLowerCase()], s === void 0)) throw new y(`Unknown adapter '${c}'`);
...
const ut = {getAdapter: In, adapters: Se};
...
function $e(e) {
    return pe(e), e.headers = A.from(e.headers), e.data = de.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), ut.getAdapter(e.adapter || X.adapter, e)(e).then(function (r) {
        return pe(e), r.data = de.call(e, e.transformResponse, r), r.headers = A.from(r.headers), r
    }, function (r) {
        return ot(r) || (pe(e), r && r.response && (r.response.data = de.call(e, e.transformResponse, r.response), r.response.headers = A.from(r.response.headers))), Promise.reject(r)
    })
}
...
ce.transitional = function (t, n, r) {
    ...
    return (i, o, c) => {
        if (t === !1) throw new y(s(o, " has been removed" + (n ? " in " + n : "")), y.ERR_DEPRECATED);
        return n && !ze[o] && (ze[o] = !0, console.warn(s(o, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(i, o, c) : !0
    }
};
...
function Mn(e, t, n) {
    ...
    for (; s-- > 0;) {
        ...
        if (o) {
            ...
            if (d !== !0) throw new y("option " + i + " must be " + d, y.ERR_BAD_OPTION_VALUE);
            continue
        }
...
const ne = {assertOptions: Mn, validators: ce}, U = ne.validators;
let q = class {
    constructor(t) {
...
` + i) : r.stack = i
    ...
    _request(t, n) {
        ...
        }, !1), s != null && (a.isFunction(s) ? n.paramsSerializer = {serialize: s} : ne.assertOptions(s, {
            encode: U.function,
...
const {
    ...
    getAdapter: ar,
    mergeConfig: cr
} = w, D = w.create({baseURL: "http://192.168.0.77:8081", timeout: 1e4, headers: {"Content-Type": "application/json"}});
D.interceptors.request.use(e => e, e => Promise.reject(e));
D.interceptors.response.use(e => e.data, e => (console.error("API Error:", e), Promise.reject(e)));
const lr = {
    getAuthUrl: () => D.get("/sso/url"),
    exchangeToken: (e, t) => D.post("/sso/token", {code: e, state: t}),
    getUserProfile: e => D.post(`/sso/user?token=${e}`),
    getUserMobile: e => D.post("/sso/mobile", e),
    logout: e => D.post("/sso/logout", e)
};
export {lr as a, D as b};
